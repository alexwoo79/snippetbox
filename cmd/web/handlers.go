...
import (
	...
	"github.com/alexwoo79/snippetbox/internal/validator"
)
...
// add a snippetCreat handle fucntion
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "email", "This field connot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be blank")
